        ...
        <div class="m-lg-3 mt-lg-3">
          <div class="card">
            <div class="card-body">
              ...
              <h1>Mostrar la lista de  Servicios</h1>
             <h2> @if (Session::has('mensaje'))
              ...
              <a  class="btn btn-primary" href="{{ url('servicios/create') }}">Crear Servicios</a>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ $servicios -> id}}</td>
                    <td>{{ $servicios -> ServiNombre}}</td>
                    <td>{{ $servicios -> ServiPrecio}}</td>


                    <td>
                    <a href="{{ url('/servicios/'.$servicios->id.'/edit') }}" class="btn btn-success">Editar</a>
                      |
